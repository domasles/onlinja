...
export const GameOverView = ({ whiteScore, blackScore, onRestart, onLeave }: GameOverViewProps) => {
    ...
    return (
        <View className="w-full bg-white border border-neutral-200/90 p-8 rounded-3xl shadow-xl items-center my-auto">
            <Text className="text-xs font-black text-neutral-400 uppercase tracking-widest mb-2">
                Match Finished
            </Text>
            <Text className="text-3xl font-black text-black tracking-tighter mb-8 text-center">
                {getWinnerLabel()}
            </Text>
            ...
            <View className="w-full flex-row justify-around items-center bg-neutral-50 border border-neutral-100 p-6 rounded-2xl mb-8">
                <View className="items-center">
                    <Text className="text-[10px] font-black text-neutral-400 tracking-wider uppercase">White</Text>
                ...
                <View className="items-center">
                    ...
                    <Text className="text-4xl font-black text-black mt-1">{blackScore}</Text>
                </View>
            </View>
