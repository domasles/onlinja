...
export const MainMenuCard = ({ activeTab, onStartGame }: MainMenuCardProps) => {
    ...
    return (
        <View className="w-full bg-white border border-neutral-200/80 p-8 rounded-b-3xl rounded-tr-3xl shadow-xl items-center">
           ...
           {activeTab === "BOT" && (
                <>
                    ...
                    <View style={{ zIndex: 50 }} className="w-full mb-6">
